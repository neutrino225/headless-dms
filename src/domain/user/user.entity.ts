...
import { Email, UserId, WorkspaceId } from "src/domain/utils/refined-types";
...
export class User extends BaseEntity<UserId> implements IUser {
	...
	static fromSerialized(raw: SerializedUser): User {
		return new User({
			...
			workspaceId: WorkspaceId.fromTrusted(raw.workspaceId),
	...
	serialize(): SerializedUser {
		return {
			...this._serialize(),
			workspaceId: WorkspaceId.toString(this.workspaceId),
