...
export type DeleteDocumentDTOEncoded = S.Schema.Encoded<typeof DeleteDocumentDTOSchema>;
...
export type ChangeDocumentStatusDTO = S.Schema.Type<typeof ChangeDocumentStatusDTOSchema>;
export type ChangeDocumentStatusDTOEncoded = S.Schema.Encoded<typeof ChangeDocumentStatusDTOSchema>;
...
export type GetDocumentByIdDTOEncoded = S.Schema.Encoded<typeof GetDocumentByIdDTOSchema>;

export const GetDocumentBySlugDTOSchema = S.Struct({
    slug: S.String,
});

export type GetDocumentBySlugDTO = S.Schema.Type<typeof GetDocumentBySlugDTOSchema>;
export type GetDocumentBySlugDTOEncoded = S.Schema.Encoded<typeof GetDocumentBySlugDTOSchema>;
...
export type ListDocumentsDTOEncoded = S.Schema.Encoded<typeof ListDocumentsDTOSchema>;
...
export type ListDocumentVersionsDTO = S.Schema.Type<typeof ListDocumentVersionsDTOSchema>;
export type ListDocumentVersionsDTOEncoded = S.Schema.Encoded<typeof ListDocumentVersionsDTOSchema>;
