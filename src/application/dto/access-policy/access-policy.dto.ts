...
export type GrantAccessDTOEncoded = S.Schema.Encoded<
	typeof GrantAccessDTOSchema
>;
...
export type UpdateAccessDTOEncoded = S.Schema.Encoded<
	typeof UpdateAccessDTOSchema
>;
...
export type RevokeAccessDTOEncoded = S.Schema.Encoded<
	typeof RevokeAccessDTOSchema
>;
...
export type CheckAccessDTOEncoded = S.Schema.Encoded<
	typeof CheckAccessDTOSchema
>;

// ─── Response DTOs ────────────────────────────────────────────────────────────

export const AccessPolicyResponseDTOSchema = S.Struct({
	id: S.String,
	documentId: S.String,
	userId: S.String,
	accessLevel: S.Enums(AccessLevel),
...
export type AccessPolicyResponseDTO = S.Schema.Type<
	typeof AccessPolicyResponseDTOSchema
>;
